      ...
      if(!empty($data)){?>
            <div itemprop="offers" itemscope itemtype="http://schema.org/Offer" class="tovar-cena_pm"> 
                       ...
                       <meta itemprop="priceCurrency" content="RUB" />
                          <p> <i style="font-style: normal;" itemprop="price" content="<?php echo $data[0]['value'];?>">
                               <?php echo $data[0]['value'];?> </i> 
                        <span>руб пог.м.  </span>
                         </p>
                             <span>
<!-- <button type="button" id="send-formx" class="btn-main  params-form<?php echo ($model->id); ?>" data-toggle="modal" data-target="#myModal"> Хочу такую кухню </button>  -->

                    <button class="btn-main params-form483" id="send-formx" type="button" data-toggle="modal" data-target="#myModal-x">Рассчитать стоимость </button>
      ...
      <?php }else{ ?>
                  ...
                  <div itemprop="offers" itemscope itemtype="http://schema.org/Offer" class="tovar-cena_pm"> 
                    <span itemprop="description"></span>
                       ...
                       <meta itemprop="priceCurrency" content="RUB" />
                          <p> 
                            <i style="font-style: normal;" itemprop="price" content="0"></i> 
                          </p>
                        </div>
    <?php  } ?>
            ...
            <?php } ?>    
              ...
              <div class="props__content prop" id="prop">
                ...
                <div class="prop__option option container">
                     <div class="product_params">
                            <?php foreach ($model->params as $param) :
                              //Учитываем начинаются на 1 больше 
                                    if($param->icon != 11 && $param->icon != 17 && $param->icon != 18 ){
                ...
                <div class="prop__desc54 text-sw">
                    <ul class="opl_dost">
                       <li>Оплата производится согласно договору.</li>
                       <li>Аванс – при заключении договора 60% от суммы и 40% перед установкой кухни.</li>
                       <li> Компания предоставляет два вида рассрочки:</li>
                    </ul>
                      <ol>
                      ...
                      <p class="opl_dost_p">Доставка:</p>  
                      <p>Доставка кухонного гарнитура производится транспортом компании. Сборка кухни занимает от одного до двух, трех дней, в зависимости от сложности и размера кухни. 
                  </p>
...
<div class="separator small"></div>
      ...
      if (empty($tab->description)) continue; ?>
		...
		<!-- разделим здесь ttt -->
            <div class="kn-45">
                <a href="/kak-proishodit-zakaz" target="_blank" class="kn-45-x kn45f" title="Узнать как порисходит заказ">Как происходит заказ?</a>
                <a href="/skolko-stoit-dizayn-proekt" target="_blank" class="kn-45-x" title="Узнать сколько стоит дизайн проект?">Сколько стоит дизайн проект?</a>
            </div>   
            <div class="form-45">
                
            <form action="" method="post" class="form-m">
                <div class='h3 h3_19'>Вызвать замерщика на обьект</div>
                <div class="flex-46">
                    <div>
                ...
                <div class="flex-47">
                    ...
                    <input type="submit" value="Заказать замер" class="btn2">
                 </div>  
